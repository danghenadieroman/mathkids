...
public class Fen_Principale extends JFrame {
    ...
    private JLabel lblUtilisateur = new JLabel("Utilisateur: ");
    private JLabel lblNiveau = new JLabel("Niveau accumulé: ");
    private JLabel lblTemps = new JLabel("Temps");
    private JLabel lblFautes = new JLabel("Fauts");
    ...
    public Fen_Principale(final String fichier, final ListeUtilisateurs liste, final Utilisateur utilisateurCourant) {
        ...
        //jpInfo
        jpInfo = new JPanel(new GridLayout());
        jpNord.add(jpInfo);
